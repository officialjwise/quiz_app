        ...
        <footer class="main-footer">
            <div class="footer-left">
                ...
                <?php } else { ?>
                    Copyright &copy; <?= date('Y') ?> Made By <strong><a href="https://https://ghostwhite-loris-398220.hostingersite.com" class="footer_dev_link" target="_blank">Pearl</a></strong>
                <?php }
                ?>
            </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">Index Number</h5>
                    </div>
